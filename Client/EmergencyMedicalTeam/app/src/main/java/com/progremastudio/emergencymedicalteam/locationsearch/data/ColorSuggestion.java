package com.progremastudio.emergencymedicalteam.locationsearch.data;
...
public class ColorSuggestion implements SearchSuggestion {
    ...
    public static final Parcelable.Creator<ColorSuggestion> CREATOR = new Creator<ColorSuggestion>() {
        @Override
